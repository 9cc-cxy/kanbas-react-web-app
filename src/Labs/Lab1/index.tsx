  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        My favorite recipe: Chocolate Oatmeal
        <ol id="wd-your-favorite-recipe">
          <li>Mix old-fashioned oatmeal with milk in a bowl.</li>
          <li>
            Place the bowl into the microwave and cook on medium for 3 minutes.
          </li>
          <li>
            Mix cacao powder, peanut butter, sugar, and a pinch of salt to the
            oatmeal.
          </li>
          <li>Add banana and chia seed as toppings.</li>
          <li>Enjoy!</li>
        </ol>
